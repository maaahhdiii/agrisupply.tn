...
async function resetProducts() {
  try {
    ...
    console.log(`Found ${allProducts.length} products. Deleting...`)
    ...
    console.log('Inserting new products with kg units...')
    ...
    console.log('✅ Successfully inserted all products with kg units!')
  } catch (err) {
